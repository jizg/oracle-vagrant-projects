...
case "$ORACLE_EDITION" in
  "EE")
    unzip '/vagrant/V17530-01_?of2.zip' -d /tmp
    ;;
  "SE2")
...
su -l oracle -c "yes | /tmp/database/runInstaller -silent -ignorePrereq -waitforcompletion -responseFile /tmp/db_install.rsp"
